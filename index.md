...
Depending on user permissions, this may include health metrics such as laboratory results, vital signs, and other clinical or wellness data made available through Apple Health.
...
• Processed entirely on the user’s device
• Stored locally within the app’s sandbox
• Never uploaded, transmitted, or synced to external servers
...
• Personalized, user-facing insights within the app

BioMIR does not use health or clinical data for:
• Advertising or ad targeting
• Tracking across apps or services
• Marketing or profiling purposes
• Sale, licensing, or brokerage of data
...
• iOS Settings → Privacy & Security → Health → BioMIR
• In-app data source controls (where available)
